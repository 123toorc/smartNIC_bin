...
.text	: ALIGN(0x100000)
{
	...
	"popcorn-hello_x86_64.o"(.text.main); /* size 0x73 */
	. = . + 0x1d; /* padding after .text.main */
...
.rodata	: ALIGN(0x100000)
{
	. = . + 1;
	. = ALIGN(0x1000);
	. = ALIGN(0x1); /* align for .rodata.popcorn_hello__str_hello__wor */
	"popcorn-hello_x86_64.o"(.rodata.popcorn_hello__str_hello__wor); /* size 0x18 */
